...
```{r RemoveNTC}
    # 1. Check and remove NTC wells and column with # of reps
    ...
    # 4. Chose bw samples ran more than once. Some samples looked like outliyers. Runned 2x and also were run from 2nd extractions (CopyNUmber PLate5)
