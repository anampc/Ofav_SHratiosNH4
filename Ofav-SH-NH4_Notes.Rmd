...
All the cores are cleary dominated by D symbionts, so I won't perform any analysis splitting the cores by clade and will use the total SH cell ratio, assuming this is basically D. 
